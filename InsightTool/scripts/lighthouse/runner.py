...
class LighthouseRunner(object):
    ...
    def __init__(self, url, form_factor='mobile', quiet=True,
        ...
        if not self.__debug:
            _, self.__report_path = tempfile.mkstemp(suffix='.json')  # TODO: uncomment
            self._run(url, form_factor, quiet, additional_settings)  # TODO: uncomment
            print(self.__report_path)
            input()
        else:
